        ...
        <Grid container spacing={3}>
          <Grid item xs={12} md={5}>
            <Box sx={{ position: 'relative' }}>
              ...
              >
                ...
                >
                  <Typography sx={{ fontWeight: 600, lineHeight: 1 }}>All over condition</Typography>
          ...
          <Grid item xs={12} md={7}>
            ...
            >
              ...
              Choice with RevealNow
            </Typography>

            <Typography sx={{ color: 'text.secondary', mb: 2, ml: { xs: 0, md: 4 } }}>
              Customize your car-buying experience with our tailored inspection services, ensuring confidence in every
              purchase.
            </Typography>
